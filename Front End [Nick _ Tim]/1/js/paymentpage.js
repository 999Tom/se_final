$(function(){
  ...
  $('.square_1_1').hover(function() {
             // 鼠标移入时添加hover类
             $('.square_1_1').css("background-color","#12ABBF");
	 ...
	 $('.square_1_2').hover(function() {
	             // 鼠标移入时添加hover类
	             $('.square_1_2').css("background-color","#12ABBF");
	  ...
	  $('.square_1_3').hover(function() {
	             // 鼠标移入时添加hover类
	             $('.square_1_3').css("background-color","#12ABBF");
	   ...
	   $('.square_1_4').hover(function() {
	             // 鼠标移入时添加hover类
	             $('.square_1_4').css("background-color","#12ABBF");
